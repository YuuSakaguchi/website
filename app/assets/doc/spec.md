...
- [Mac](https://github.com/standardnotes/desktop/releases/download/v0.2.3/standard-notes-0.2.3-mac.zip)
- [Windows](https://github.com/standardnotes/desktop/releases/download/v0.2.3/standard-notes-Setup-0.2.3.exe)
- [Linux](https://github.com/standardnotes/desktop/releases/download/v0.2.3/standard-notes-0.2.3-x86_64.AppImage)
